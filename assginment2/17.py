...
def HillClimbing(startState , finalState, WhichHeurestic):
    ...
    while(True):
        ...
        if(queu.empty()):
            print("There is no solution for HC approach with Heuristic" + str(WhichHeurestic))
            return False
...
print("#######################################################################################################################################")
print()
print("For Hill Climbing in StateHeuristic vlaue is ")
print(HillClimbing(startState, finalState, 1))
print("#######################################################################################################################################")
print()
print("For Hill Climbing in HeightHeuristic vlaue is ")
print(HillClimbing(startState, finalState, 2))
print("#######################################################################################################################################")
print()
print("For Hill Climbing in HeightSquareHeuristic vlaue is ")
print(HillClimbing(startState, finalState, 3))
print("#######################################################################################################################################")
